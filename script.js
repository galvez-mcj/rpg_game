...
const locations = [
    {
        ...
        text: 'The monster screams \'ArggggH!\' as it dies. You gained experience points and found gold...'
    }, {
        name: "lose",
        ...
        text: 'You found the secret game! Pick a number above. Ten numbers will be randomly chosen betwwen 0 and 10. If the number matches one of the random numbers, you win!'
    }
]
...
function buyHealth() {
    if (gold >= 10) {
        ...
        text.textContent = 'You don\'t have enough gold to buy health...'
    }
}
...
function buyWeapon() {
    if (currentWeapon < weapons.length - 1){
        if (gold >= 30) {
            ...
            text.textContent += 'Your current inventory is: ' + inventory
        } else {
...
function pick(guess){
    ...
    if (numbers.indexOf(guess) !== -1) {
        text.textContent += 'You\'ve guessed it! You win 20 gold!'
        gold += 20
        goldText.textContent = gold
    } else {
        text.textContent += 'You\'re wrong :( You lose 10 health...'
        health -= 10
        healthText.textContent = health
        if (health <= 0) {
            lose()
